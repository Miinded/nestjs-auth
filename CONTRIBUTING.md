...
.
├── packages/
│   ├── nestjs-auth-api-keys/   # @miinded/nestjs-auth-api-keys — API key authentication
│   │   └── src/
│   │       ├── guard/          # AuthGuard
│   │       ├── interface/      # IAuthApiKeys
│   │       ├── middleware/     # ConfigApiKeysMiddleware
│   │       ├── strategy/       # PassportAuthApiKeyStrategy
│   │       ├── decorator.ts
│   │       └── index.ts        # Public barrel export
│   └── nestjs-auth-jwt/        # @miinded/nestjs-auth-jwt — JWT authentication
│       └── src/
│           ├── controllers/    # AuthJwtController
│           ├── guards/         # JwtRefreshTokenGuard
│           ├── interface/      # IJwtAuth
│           ├── middleware/     # JwtMiddleware
│           ├── strategy/       # JwtStrategy, JwtRefreshTokenStrategy
│           ├── decorator.ts
│           └── index.ts        # Public barrel export
